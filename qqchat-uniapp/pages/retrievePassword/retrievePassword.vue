<template>
	...
	<view>
		...
		<view class="form userform">
			...
			<view class="password">
				<input placeholder="请输入新密码" v-model="password" password=true
					placeholder-style="color: rgba(255,255,255,0.8);" />
			</view>
			<view class="password">
				<input placeholder="确认新密码" v-model="password1" password=true
					placeholder-style="color: rgba(255,255,255,0.8);" />
			</view>
			<view class="btn" @tap="doReg">找回密码</view>
			<view class="res">
				<view @tap="toLogin">取消</view>
			</view>
		</view>
